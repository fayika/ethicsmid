...
summary(backward)
names(dat1)
FraminghamLog1 = glm(TenYearCHD ~ .-education-BPMeds-currentSmoker-BMI-prevalentHyp-diaBP-diabetes-prevalentStroke-heartRate, data = df.train, family=binomial)
...
Oddratio = exp(raminghamLog$coefficients)
Oddratio
